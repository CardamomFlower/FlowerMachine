...
namespace flowermachine
{
    ...
    */
    /*  The strip controls sit over the bottom third of every ready cart, and JUCE acts on a
        ...
        the preset, a right-drag on the knob would change the gain. The whole cart belongs to
        the context menu, so these two hand a popup-menu press back to the cart and never let
        the base class see it.
    */
