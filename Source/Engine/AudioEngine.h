...
{
    /*  Owns the output device and the audio callback:
        ...
        All public methods are message-thread only. The callback side allocates
        nothing, takes no lock and does no IO.
    */
